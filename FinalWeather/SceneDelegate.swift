...
//  FinalWeather
//
//  Created by Tina Andriamandimby on 08/09/2020.
//  Copyright © 2020 Tina Andriamandimby. All rights reserved.
//
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(
        ...
        let displayWeatherPage = DisplayWeatherViewController(viewModel: viewModel)
        self.window = UIWindow(windowScene: windowScene)
        self.window?.rootViewController = displayWeatherPage
